// generate note dots in resize
  ...
  function displayTask() {
    ...
    let year = String(today.getFullYear() + 1).padStart(2, "0");
    ...
    for (let i = 0; i < tasks.length; i++) {
      if (tasks[i].status == false) {
        ...
        <th>
          ...
          <i onclick="checked(${i})" class="fa-solid fa-square-check d-none">done</i>
        </th>
        <th><i onclick="deleteTask(${i})" class="fa-solid fa-trash-can">Delete</i></th>
      </tr>
        `;
      } else {
        box += `
        ...
        <th>
          ...
          ><i onclick="checked(${i})" class="fa-solid fa-square-check">ongoing</i>
        </th>
        <th><i onclick="deleteTask(${i})" class="fa-solid fa-trash-can">Delete</i></th>
